#!/usr/bin/env bash
###############################################################################
# Pretrain Trans-WM from offline replay data.
#
# Usage:
...
echo "[run_pretrain_trans_wm] epochs=${EPOCHS} batch_size=${BATCH_SIZE} planning_horizon=${PLANNING_HORIZON} device=${DEVICE:-auto}"
